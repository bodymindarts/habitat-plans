...
pkg_deps=(core/diffutils core/hg core/glibc core/which core/pkg-config core/m4 core/rsync core/git core/gcc core/patch core/make bodymindarts/ocaml bodymindarts/ocamlbuild bodymindarts/camlp4)
pkg_bin_dirs=(bin)
